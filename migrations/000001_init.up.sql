...
drop table if exists dbo.t_purchases;
drop table if exists dbo.t_admins;
drop table if exists dbo.t_flights;
drop table if exists dbo.t_users;
drop table if exists dbo.t_aircraft_models;
drop table if exists dbo.t_airlines;
drop table if exists dbo.t_airports;
drop table if exists dbo.t_countries;


create table dbo.t_aircraft_models(
    aircraft_model_id int NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    aircraft_iata_code varchar(100) ,
    aircraft_icaic_code varchar(100) ,
    aircraft_model_name varchar(100) ,
    aircraft_model_manufacturer varchar(100) ,
    aircraft_model_wing_type varchar(100) ,
    aircraft_model_type varchar(100) ,
    economy_class_flg char(1) default('N'),
    pr_economy_class_flg char(1) default('N'),
    business_class_flg char(1) default('N'),
    first_class_flg char(1) default('N'),
...
create table dbo.t_airlines(
    ...
    airline_active_flg char(1) default('N'),
    change_dttm timestamptz not null default(current_timestamp),
    CONSTRAINT CK_active_flg CHECK (airline_active_flg IN ('Y','N')),
    CONSTRAINT FK_country FOREIGN KEY (airline_country_id) REFERENCES dbo.t_countries (country_id),
...
create table dbo.t_airports(
    ...
    airport_iso_region varchar(100),
    airport_municipality varchar(100),
    airport_iata_code varchar(100),
    airport_home_link varchar(1000),
    visa_flg char(1) default('N'),
    quarantine_flg char(1) default('N'),
    covid_test_flg char(1) default('N'),
    lockdown_flg char(1) default('N'),
    change_dttm timestamptz not null default(current_timestamp),
    ...
    CONSTRAINT CK_airport_type CHECK (airport_type IN ('balloonport',
                                                        ...
                                                        'medium_airport',
                                                        'small_airport')),
   CONSTRAINT FK_iso_country FOREIGN KEY (airport_iso_country_id)REFERENCES dbo.t_countries (country_id),
...
create table dbo.t_flights(
    ...
    wifi_flg char(1) default('N'),
    food_flg char(1) default('N'),
    usb_flg char(1) default('N'),
    change_dttm timestamptz not null default(current_timestamp),
...
create table dbo.t_users(
    ...
    card_number varchar(1000) NOT NULL DEFAULT(''),
    card_exp_date varchar(100) NOT NULL DEFAULT(''),
    card_individual varchar(100) NOT NULL DEFAULT(''),
...
create table dbo.t_purchases(
    ...
    class_flg varchar(100)  default('N'),
    food_flg char(1)  default('N'),
    payed int default 1,
    pay_method varchar(100) default 'none',
    purchase_dttm timestamptz not null default(current_timestamp),
    change_dttm timestamptz not null default(current_timestamp),
    payed_dttm timestamptz not null default(current_timestamp),
    ...
    CONSTRAINT CK_purch_pay_method CHECK (pay_method IN ('none', 'card','apple_pay','google_pay')),
    PRIMARY KEY (purchase_id)
);


ALTER TABLE dbo.t_flights ALTER COLUMN ticket_num_economy_class SET DEFAULT 0;
ALTER TABLE dbo.t_flights ALTER COLUMN ticket_num_pr_economy_class SET DEFAULT 0;
ALTER TABLE dbo.t_flights ALTER COLUMN ticket_num_business_class SET DEFAULT 0;
ALTER TABLE dbo.t_flights ALTER COLUMN ticket_num_first_class SET DEFAULT 0;
