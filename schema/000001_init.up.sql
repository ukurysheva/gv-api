...
create table dbo.t_flights(
    ...
    airline_id int,
    ticket_num_economy_class int,
    ticket_num_pr_economy_class int,
    ticket_num_business_class int,
    ticket_num_first_class int,
...
create table dbo.t_clients(
    ...
    create_dttm timestamptz not null default(current_timestamp),
    change_dttm timestamptz not null default(current_timestamp),
    CONSTRAINT FK_country_id FOREIGN KEY (client_country_id)
        REFERENCES dbo.t_countries (country_id),
...
create table dbo.t_purchases(
    ...
    CONSTRAINT FK_purch_client_id FOREIGN KEY (client_id)
